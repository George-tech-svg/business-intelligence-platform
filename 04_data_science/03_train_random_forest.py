...
Saves the best model to models/random_forest_best.pkl
"""
...
def main():
    ...
    # Parameter grid to test (reduced for speed)
    param_grid = {
        'n_estimators': [50, 100],
        'max_depth': [3, 5, 7],
    ...
    # Save best model
    save_model(grid_search.best_estimator_, "random_forest_best")
    ...
    print('-'*140)
    print("STATUS: Random Forest training complete")
    print('-'*140)
